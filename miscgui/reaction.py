...
def add_mousemotion_reaction(element, func, event_args=None, params=None,
                            reac_name=None):
    reac = ConstantReaction(pygame.MOUSEMOTION, func, event_args, params,
            reac_name)
    element.add_reaction(reac)

def add_click_reaction(element, func, event_args=None, params=None,
                            reac_name=None):
    reac = ConstantReaction(pygame.MOUSEBUTTONDOWN, func, event_args, params,
            reac_name)
    element.add_reaction(reac)
